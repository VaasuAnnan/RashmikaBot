...
➪ 𝑫𝒆𝒗𝒐𝒍𝒐𝒑𝒆𝒓 : <a href='https://t.me/MSMadminBot">𝑪𝒍𝒊𝒄𝒌 𝑯𝒆𝒓𝒆</a>
➪ 𝑳𝒊𝒃𝒓𝒂𝒓𝒚 : 𝑷𝒚𝒓𝒐𝒈𝒓𝒂𝒎</b>
➪ 𝑳𝒂𝒏𝒈𝒖𝒂𝒈𝒆 : 𝑷𝒚𝒕𝒉𝒐𝒏 3</b>
➪ 𝑫𝒂𝒕𝒂 𝒃𝒂𝒔𝒆 : 𝑴𝒐𝒏𝒈𝒐𝑫𝑩</b>
➪ 𝑩𝒐𝒕 𝒔𝒆𝒓𝒗𝒆𝒓 : <a href="https://t.me/Nokkiirunnoippolkittum">𝑭𝒓𝒆𝒆 𝑽𝑷𝑺</a>
➪ 𝑩𝒖𝒊𝒍𝒅 𝑺𝒕𝒂𝒕𝒖𝒔 : v2.0.3 [ 𝑺𝒕𝒂𝒃𝒍𝒆 ]</b>""" 

    SOURCE_TXT = """<b>ɴᴏᴛᴇ:
- 𝚃𝙷𝙸𝚂 𝙱𝙾𝚃 𝙸𝚂 𝙰𝙽 𝙷𝙸𝙶𝙷𝙻𝚈 𝙿𝙾𝚆𝙴𝚁𝙵𝚄𝙻 𝙰𝙽𝙳 𝚂𝙸𝙼𝙿𝙻𝙴.
- ꜱᴏᴜʀᴄᴇ - <a href="https://t.me/Nokkiirunnoippolkittum">𝙲𝙻𝙸𝙲𝙺 𝙷𝙴𝚁𝙴</a>
Dᴇᴠᴇʟᴏᴘᴇʀ:
- <a href="https://t.me/MSMadminBot">𝙲𝙻𝙸𝙲𝙺 𝙷𝙴𝚁𝙴</a></b>"""
...
• ꜰᴜʟʟ ɴᴀᴍᴇ : 𝙼𝚂𝙼 𝙰𝙳𝙼𝙸𝙽 𝙱𝙾𝚃
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href='t.me/MSMadminBot'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """
<b>📂 𝐅𝐢𝐥𝐞 𝐍𝐚𝐦𝐞 : <code>{file_name}</code
